...
import { TextArea, Input, InputWrapper } from "../composites";
    ...
    <>
      <ProjectLayout
        ...
        page={{
          ...
          desc: "Create, update, delete database for the storage",
          actionButton: (
            <>
              <Button
                variant="primary"
      ...
      <ModalComponent header="Add Storage" {...modalDisclosure}>
        <Box>
          <Grid gap={4} mt={2}>
            <Input title="Storage Name" />

            <InputWrapper title="Private">
